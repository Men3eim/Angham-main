            ...
            <table id="seatsBlock">
                <tbody>
                    ...
                    <tr>
...

                        {
                            arr.slice( 0, 24 ).map( ( chair ) => {
                                return <td chair={ chair } key={ chair.xd }><input type="checkbox" className="seats" value={ chair.xd } id={ chair.xd } /><div className="mapped" style={ { backgroundColor: cellColor( chair.color ), pointerEvents: 'none' } }><label htmlFor={ chair.xd } ><img src='/fill.png' alt="" /></label></div></td>
                            }
                            )
                        }
                        <td className="seatGap" colSpan={ 3 }>................</td>
                    ...
                    <tr>
                        ...
                        <p className="seatCGap" style={ { fontFamily: 'Times New Roman', color: '#E5E4E1' } }>Platinum</p>
                        <td className="seatGap" colSpan={ 1 }>................</td>
                        {
